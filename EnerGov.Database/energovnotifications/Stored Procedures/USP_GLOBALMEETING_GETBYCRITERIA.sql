CREATE PROCEDURE [energovnotifications].[USP_GLOBALMEETING_GETBYCRITERIA]
(
	@MeetingTypeIDs RecordIDs READONLY,-- MEETING TYPE IDS
	@STARTDATE DATETIME,
	@ENDDATE DATETIME
)              
AS
...
SET NOCOUNT ON;
	...
	WHERE
	 ...
	 AND [dbo].[MEETINGTYPE].[MEETINGTYPEID] in (SELECT RECORDID FROM @MeetingTypeIDs)
