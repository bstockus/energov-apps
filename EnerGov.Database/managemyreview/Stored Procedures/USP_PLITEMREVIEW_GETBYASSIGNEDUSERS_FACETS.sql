CREATE PROCEDURE [managemyreview].[USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS]
(
...
DECLARE @ITEMREVIEWLIST RECORDIDS;
...
BEGIN
	...
	WHERE		NOTREQUIRED = 0 
	AND			(NOT EXISTS(SELECT * FROM @ASSIGNEDUSERLIST) OR ASSIGNEDUSERID IN (SELECT RECORDID FROM @ASSIGNEDUSERLIST))
...
BEGIN
	...
	FROM		PLITEMREVIEW
	WHERE		NOTREQUIRED = 0 AND (NOT EXISTS(SELECT * FROM @ASSIGNEDUSERLIST) OR ASSIGNEDUSERID IN (SELECT RECORDID FROM @ASSIGNEDUSERLIST))
	AND			PLITEMREVIEW.COMPLETED = 1
	
END

EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_ASSIGNEDTO @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_ENTITYNUMBER @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_COMPLETEDDATE @ITEMREVIEWLIST, @LAST30DAYS, @LASTWEEKFIRSTDAY, @LASTWEEKLASTDAY, @THISWEEKFIRSTDAY, @THISWEEKLASTDAY, @THISWEEKLABEL, @LASTWEEKLABEL, @LAST30DAYSLABEL
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_DUEDATE @ITEMREVIEWLIST, @OVERDUEDATE, @TODAYDUEBEGINDATE, @TODAYDUEENDDATE, @UPCOMINGDUEBEGINDATE, @UPCOMINGDUEENDDATE, @TODAYLABEL, @NEXT5DAYSLABEL, @OVERDUELABEL
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_ENTITYTYPE @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_ENTITYCLASS @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_SUBMITTALTYPE @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_REVIEWSTATUS @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_REVIEWTYPE @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_PROJECT @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_VERSIONNUMBER @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_ADDRESS @ITEMREVIEWLIST
EXEC [managemyreview].USP_PLITEMREVIEW_GETBYASSIGNEDUSERS_FACETS_TEAM @ITEMREVIEWLIST, @INCLUDETEAM, @MANAGERID
