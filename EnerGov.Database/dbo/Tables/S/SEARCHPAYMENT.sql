CREATE TABLE [dbo].[SEARCHPAYMENT] (
    [SEARCHPAYMENTID]           CHAR (36)      NOT NULL,
    ...
    CONSTRAINT [PK_SEARCHPAYMENT] PRIMARY KEY CLUSTERED ([SEARCHPAYMENTID] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_SRCHPAY_CAENTITYID] FOREIGN KEY ([CASHIERLINKID]) REFERENCES [dbo].[CAENTITY] ([CAENTITYID]),
    CONSTRAINT [FK_SRCHPAY_CAINVOICESTATUSID] FOREIGN KEY ([INVOICESTATUSID]) REFERENCES [dbo].[CASTATUS] ([CASTATUSID]),
    CONSTRAINT [FK_SRCHPAY_CAPAYTYPEID] FOREIGN KEY ([PAYMENTTYPEID]) REFERENCES [dbo].[CAPAYMENTTYPE] ([CAPAYMENTTYPEID]),
    CONSTRAINT [FK_SRCHPAY_CAPTRANSTYPEID] FOREIGN KEY ([CATRANSACTIONTYPEID]) REFERENCES [dbo].[CATRANSACTIONTYPE] ([CATRANSACTIONTYPEID]),
    CONSTRAINT [FK_SRCHPAY_CATRANSTATUSID] FOREIGN KEY ([PAYMENTSTATUSID]) REFERENCES [dbo].[CATRANSACTIONSTATUS] ([CATRANSACTIONSTATUSID]),
    CONSTRAINT [FK_SRCHPAY_CREATEDBYUSERID] FOREIGN KEY ([CREATEDBYUSER]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHPAY_CRITERIAUSERID] FOREIGN KEY ([CRITERIAUSERID]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHPAY_FEETYPEID] FOREIGN KEY ([CAFEETYPEID]) REFERENCES [dbo].[CAFEETYPE] ([CAFEETYPEID]),
    CONSTRAINT [FK_SRCHPAY_INVCREATEDBYUSERID] FOREIGN KEY ([INVOICECREATEDBYUSER]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHPAY_OFFICEID] FOREIGN KEY ([OFFICE]) REFERENCES [dbo].[OFFICE] ([OFFICEID])
);
