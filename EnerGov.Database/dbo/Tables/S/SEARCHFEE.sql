CREATE TABLE [dbo].[SEARCHFEE] (
    [SEARCHFEEID]               CHAR (36)      NOT NULL,
    ...
    CONSTRAINT [PK_SEARCHFEE] PRIMARY KEY CLUSTERED ([SEARCHFEEID] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_SRCHFEE_CAENTITYID] FOREIGN KEY ([CASHIERLINKID]) REFERENCES [dbo].[CAENTITY] ([CAENTITYID]),
    CONSTRAINT [FK_SRCHFEE_CAINVOICESTATUSID] FOREIGN KEY ([INVOICESTATUSID]) REFERENCES [dbo].[CASTATUS] ([CASTATUSID]),
    CONSTRAINT [FK_SRCHFEE_CAPAYTYPEID] FOREIGN KEY ([PAYMENTTYPEID]) REFERENCES [dbo].[CAPAYMENTTYPE] ([CAPAYMENTTYPEID]),
    CONSTRAINT [FK_SRCHFEE_CAPTRANSTYPEID] FOREIGN KEY ([CATRANSACTIONTYPEID]) REFERENCES [dbo].[CATRANSACTIONTYPE] ([CATRANSACTIONTYPEID]),
    CONSTRAINT [FK_SRCHFEE_CATRANSTATUSID] FOREIGN KEY ([PAYMENTSTATUSID]) REFERENCES [dbo].[CATRANSACTIONSTATUS] ([CATRANSACTIONSTATUSID]),
    CONSTRAINT [FK_SRCHFEE_CREATEDBYUSERID] FOREIGN KEY ([CREATEDBYUSER]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHFEE_CRITERIAUSERID] FOREIGN KEY ([CRITERIAUSERID]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHFEE_FEETYPEID] FOREIGN KEY ([CAFEETYPEID]) REFERENCES [dbo].[CAFEETYPE] ([CAFEETYPEID]),
    CONSTRAINT [FK_SRCHFEE_INVCREATEDBYUSERID] FOREIGN KEY ([INVOICECREATEDBYUSER]) REFERENCES [dbo].[USERS] ([SUSERGUID]),
    CONSTRAINT [FK_SRCHFEE_OFFICEID] FOREIGN KEY ([OFFICE]) REFERENCES [dbo].[OFFICE] ([OFFICEID])
);
