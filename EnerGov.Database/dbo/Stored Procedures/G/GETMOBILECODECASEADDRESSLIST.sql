CREATE PROCEDURE GETMOBILECODECASEADDRESSLIST
@CodeCaseId char(36)
AS
BEGIN
SELECT	DISTINCT CMCODECASEADDRESS.CMCODECASEADDRESSID,
		...
		INNER JOIN MAILINGADDRESS ON MAILINGADDRESS.MAILINGADDRESSID = CMCODECASEADDRESS.MAILINGADDRESSID	
		WHERE CMCODECASEADDRESS.CMCODECASEID = @CodeCaseId	ORDER BY MAILINGADDRESS.ADDRESSLINE1
END
