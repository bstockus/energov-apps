...
CREATE PROCEDURE [dbo].[rpt_SR_SR_Permit_Setup_Fee_Template]
...
INNER JOIN PMPERMITTYPEWORKCLASS ON CAFEETEMPLATE.CAFEETEMPLATEID = PMPERMITTYPEWORKCLASS.CAFEETEMPLATEID
