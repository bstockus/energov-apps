...
CREATE PROCEDURE [dbo].[rpt_IM_Inspection_Listing_Report_By_Scheduled_End_Date]
...
SELECT     COALESCE (BLLICENSE.LICENSENUMBER, CMCODECASE.CASENUMBER, PLPLAN.PLANNUMBER, PMPERMIT.PERMITNUMBER) AS CaseNumber, 
                      ...
                      IMINSPECTION.IMINSPECTIONID, IMINSPECTION.SCHEDULEDENDDATE
...
WHERE IMINSPECTION.SCHEDULEDENDDATE BETWEEN @STARTDATE AND @ENDDATE
