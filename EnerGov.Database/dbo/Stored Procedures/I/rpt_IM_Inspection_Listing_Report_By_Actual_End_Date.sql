...
CREATE PROCEDURE [dbo].[rpt_IM_Inspection_Listing_Report_By_Actual_End_Date]
...
SELECT     COALESCE (BLLICENSE.LICENSENUMBER, CMCODECASE.CASENUMBER, PLPLAN.PLANNUMBER, PMPERMIT.PERMITNUMBER) AS CaseNumber, 
                      ...
                      IMINSPECTION.IMINSPECTIONID, IMINSPECTION.ACTUALENDDATE, IMINSPECTION.IMINSPECTIONLINKID
...
WHERE IMINSPECTION.ACTUALENDDATE BETWEEN @STARTDATE AND @ENDDATE
