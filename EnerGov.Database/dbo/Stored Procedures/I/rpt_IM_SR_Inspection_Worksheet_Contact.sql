...
-- [dbo].[rpt_IM_SR_Inspection_Worksheet_Contact] 'eceb1e61-adea-4c35-98b9-d0200e1d92a4'
CREATE PROCEDURE [dbo].[rpt_IM_SR_Inspection_Worksheet_Contact]
...
SELECT COALESCE (LANDMANAGEMENTCONTACTTYPE.NAME,C.NAME) AS ContactType, 
...
FROM   IMINSPECTIONCONTACT 
				  ...
				  LEFT OUTER JOIN CMCODECASECONTACTTYPE C ON IMINSPECTIONCONTACT.CONTACTTYPEID = C.CMCODECASECONTACTTYPEID
