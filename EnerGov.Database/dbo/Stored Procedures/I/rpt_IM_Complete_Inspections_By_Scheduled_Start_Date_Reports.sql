...
CREATE PROCEDURE [dbo].[rpt_IM_Complete_Inspections_By_Scheduled_Start_Date_Reports]
...
WHERE IM.SCHEDULEDSTARTDATE BETWEEN @STARTDATE AND @ENDDATE 
AND IM.COMPLETE = 'True'
