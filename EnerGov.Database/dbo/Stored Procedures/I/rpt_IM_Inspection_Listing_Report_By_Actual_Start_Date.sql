...
CREATE PROCEDURE [dbo].[rpt_IM_Inspection_Listing_Report_By_Actual_Start_Date]
...
SELECT     COALESCE (BLLICENSE.LICENSENUMBER, CMCODECASE.CASENUMBER, PLPLAN.PLANNUMBER, PMPERMIT.PERMITNUMBER) AS CaseNumber, 
                      ...
                      IMINSPECTION.IMINSPECTIONID, IMINSPECTION.ACTUALSTARTDATE
...
WHERE IMINSPECTION.ACTUALSTARTDATE BETWEEN @STARTDATE AND @ENDDATE
