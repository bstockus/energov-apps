...
/****** OBJECT:  StoredProcedure [dbo].[rpt_IP_SR_Impact_Case_Attached_Records_Report_Address]    Script Date: 01/08/2014 15:58:53 ******/
CREATE PROCEDURE [dbo].[rpt_IP_SR_Impact_Case_Attached_Records_Report_Address]
...
SELECT	MAILINGADDRESS.ADDRESSLINE1, MAILINGADDRESS.ADDRESSLINE2, MAILINGADDRESS.ADDRESSLINE3, MAILINGADDRESS.CITY, MAILINGADDRESS.STATE, 
		...
		IPCASEADDRESS.MAILINGADDRESSID, IPCASEADDRESS.MAIN
