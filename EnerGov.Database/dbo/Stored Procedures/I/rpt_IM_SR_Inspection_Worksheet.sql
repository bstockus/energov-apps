...
/*
exec [rpt_IM_SR_Inspection_Worksheet] '01559a47-b50c-4ec3-8a77-15b7667ba42c'
select * from iminspectionchecklistxref order by iminspectionid
*/
CREATE PROCEDURE [dbo].[rpt_IM_SR_Inspection_Worksheet]
...
SELECT IMINSPECTION.INSPECTIONNUMBER AS InspectionNumber, IMINSPECTION.LINKNUMBER AS CaseNumber, IMINSPECTION.ACTUALSTARTDATE AS ActualStartDate, 
       IMINSPECTIONTYPE.NAME AS InspectionType, IMINSPECTIONSTATUS.STATUSNAME AS InspectionStatus, IMINSPECTIONLINK.NAME AS Entity, MAILINGADDRESS.ADDRESSLINE1, 
	   ...
	   MAILINGADDRESS.UNITORSUITE, CHECKLIST.ChecklistItem, 
	   COALESCE(CHECKLIST.Passed,0) AS Passed, CHECKLIST.Comments, CHECKLIST.CheckListDesc, CHECKLIST.ORDERNUM
...
LEFT  JOIN (SELECT IMCHECKLIST.NAME AS ChecklistItem, IMCHECKLIST.[DESCRIPTION] AS CheckListDesc, IMINSPECTIONCHECKLISTXREF.PASSED AS Passed
					, IMINSPECTIONCHECKLISTXREF.COMMENTS AS Comments, IMINSPECTIONCHECKLISTXREF.IMINSPECTIONID, IMINSPECTIONCHECKLISTXREF.ORDERNUM
			FROM IMCHECKLIST 
...
IMINSPECTIONCASE.CASENO AS InspectionNumber,
	   ...
	   MAILINGADDRESS.ADDRESSLINE2, MAILINGADDRESS.ADDRESSLINE3, MAILINGADDRESS.CITY, MAILINGADDRESS.[STATE], 
	   MAILINGADDRESS.POSTALCODE, MAILINGADDRESS.POSTDIRECTION, MAILINGADDRESS.PREDIRECTION, MAILINGADDRESS.STREETTYPE, 
	   MAILINGADDRESS.UNITORSUITE, CHECKLIST.ChecklistItem, CHECKLIST.Passed, CHECKLIST.Comments, CHECKLIST.CheckListDesc, CHECKLIST.ORDERNUM,
	    (SELECT PARCEL.PARCELNUMBER AS ParcelNumber
...
LEFT  JOIN (SELECT IMCHECKLIST.NAME AS ChecklistItem, IMCHECKLIST.[DESCRIPTION] AS CheckListDesc, IMINSPECTIONCHECKLISTXREF.PASSED AS Passed
					, IMINSPECTIONCHECKLISTXREF.COMMENTS AS Comments, IMINSPECTIONCASE.IMINSPECTIONCASEID, IMINSPECTIONCHECKLISTXREF.ORDERNUM,
