...
CREATE PROCEDURE [dbo].[rpt_CA_Payments_By_User_Report]
...
SELECT CACOMPUTEDFEE.CACOMPUTEDFEEID, CACOMPUTEDFEE.FEENAME, CACOMPUTEDFEE.COMPUTEDAMOUNT, CATRANSACTIONFEE.PAIDAMOUNT, CATRANSACTIONFEE.REFUNDAMOUNT, 
       USERS.ID, USERS.SUSERGUID, USERS.FNAME, USERS.LNAME, CAINVOICE.INVOICENUMBER, CATRANSACTIONPAYMENT.PAYMENTDATE, CAPAYMENTMETHOD.NAME AS PaymentMethod, 
       CATRANSACTIONPAYMENT.SUPPLEMENTALDATA, CATRANSACTIONTYPE.NAME AS TransactionType
FROM CACOMPUTEDFEE 
