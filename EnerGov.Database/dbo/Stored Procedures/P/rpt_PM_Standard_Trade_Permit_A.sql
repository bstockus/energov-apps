...
CREATE PROCEDURE rpt_PM_Standard_Trade_Permit_A
...
SELECT P.PMPERMITID, P.PERMITNUMBER, P.ISSUEDATE, P.EXPIREDATE, P.SQUAREFEET, P.[VALUE], P.DESCRIPTION,
	...
	(SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>')  FROM RPTTEXTLIB R
		WHERE R.TEXTNAME = 'Trade_Permit_A_Text_1') Trade_Permit_A_Text_1,
	(SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>')  FROM RPTTEXTLIB R
		WHERE R.TEXTNAME = 'Trade_Permit_A_Text_2') Trade_Permit_A_Text_2,
