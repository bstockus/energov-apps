...
CREATE PROCEDURE [dbo].[rpt_PR_Incomplete_Project_Listing_Report_By_Expected_End_Date]
...
WHERE PRPROJECT.EXPECTEDENDDATE BETWEEN @STARTDATE AND @ENDDATE AND PRPROJECT.COMPLETEDATE IS NULL
