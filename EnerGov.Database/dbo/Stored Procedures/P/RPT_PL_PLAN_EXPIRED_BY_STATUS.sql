...
CREATE PROCEDURE [dbo].[RPT_PL_PLAN_EXPIRED_BY_STATUS]
...
SELECT PLPlanType.PLANNAME, PLPlan.PLANNUMBER, PLPLANSTATUS.NAME AS STATUS, 
       PLPlan.APPLICATIONDATE, CONVERT( VARCHAR(10), PLPLAN.EXPIREDATE, 101) AS [EXPIREDATE] , Users.FNAME, Users.LNAME, Parcel.PARCELNUMBER, PLPlanParcel.MAIN
