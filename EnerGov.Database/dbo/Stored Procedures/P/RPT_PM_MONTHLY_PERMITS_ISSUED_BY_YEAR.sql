...
CREATE PROCEDURE [dbo].[RPT_PM_MONTHLY_PERMITS_ISSUED_BY_YEAR]
@STARTDATE AS DATETIME,
@ENDDATE AS DATETIME
AS
SET @ENDDATE = DATEADD(S,-1,DATEADD(D,1,@ENDDATE))

SELECT PMPERMIT.PMPERMITID, PMPERMIT.ISSUEDATE, PMPERMIT.VALUE,
       PMPERMITTYPE.NAME AS PermitType, PMPERMITWORKCLASS.NAME AS PermitWorkClass
FROM PMPERMIT 
