...
CREATE PROCEDURE [dbo].[RPT_PM_PERMITS_FINALIZE_REPORTS]
@STARTDATE AS DATETIME,
@ENDDATE AS DATETIME
AS
SET @ENDDATE = DATEADD(S,-1,DATEADD(D,1,@ENDDATE))
SELECT PMPERMIT.FINALIZEDATE, PMPERMIT.PERMITNUMBER, PMPERMITTYPE.NAME AS PERMITTYPE, PMPERMITSTATUS.NAME AS STATUS, PRPROJECT.NAME AS PROJECT, 
...
WHERE PMPERMIT.FINALIZEDATE BETWEEN @STARTDATE AND @ENDDATE
