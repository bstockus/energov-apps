...
CREATE PROCEDURE [dbo].[RPT_PL_PLAN_COMPLETED_BY_STATUS]
...
SELECT PLPlanType.PLANNAME, PLPlan.PLANNUMBER, PLPLANSTATUS.NAME AS STATUS, 
       PLPlan.APPLICATIONDATE, CONVERT( VARCHAR(10), PLPLAN.COMPLETEDATE, 101) AS COMPLETEDATE , Users.FNAME, Users.LNAME, Parcel.PARCELNUMBER, PLPlanParcel.MAIN
...
AND PLPLAN.COMPLETEDATE IS NOT NULL
ORDER BY PLPLAN.COMPLETEDATE
