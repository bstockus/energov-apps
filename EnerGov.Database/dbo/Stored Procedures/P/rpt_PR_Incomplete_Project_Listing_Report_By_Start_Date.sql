...
CREATE PROCEDURE [dbo].[rpt_PR_Incomplete_Project_Listing_Report_By_Start_Date]
...
WHERE PRPROJECT.STARTDATE BETWEEN @STARTDATE AND @ENDDATE AND PRPROJECT.COMPLETEDATE IS NULL
