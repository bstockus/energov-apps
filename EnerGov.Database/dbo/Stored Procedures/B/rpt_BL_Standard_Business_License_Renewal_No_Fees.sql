-- exec rpt_BL_Standard_Business_License_Renewal_No_Fees '0ef9a8ed-c48b-435b-a94c-4a1e5bac9430',''

CREATE PROCEDURE rpt_BL_Standard_Business_License_Renewal_No_Fees
...
SELECT BL.BLLICENSEID, BL.LICENSENUMBER, CASE WHEN BL.EXPIRATIONDATE = '1/1/2999' THEN NULL ELSE BL.EXPIRATIONDATE END AS EXPIRATIONDATE, 
	...
	(SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R
		WHERE R.TEXTNAME = 'Business_License_Renewal_Text1') Business_License_Renewal_Text1,
	(SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R
		WHERE R.TEXTNAME = 'Business_License_Renewal_Text2') Business_License_Renewal_Text2,
	(SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R
		WHERE R.TEXTNAME = 'Business_License_Renewal_Text3') Business_License_Renewal_Text3,
