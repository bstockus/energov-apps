...
CREATE PROCEDURE [dbo].[rpt_Business_License_Companies_Reports_By_Open_Date]
...
WHERE BLGlobalEntityExtension.OpenDate >= @STARTDATE AND BLGlobalEntityExtension.OpenDate <= @ENDDATE and BLGlobalEntityExtensionAddress.Main = 'True'
