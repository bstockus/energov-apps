...
-- exec rpt_BL_Standard_Business_License_Renewal_Report_No_Fees '20180801','20180814','issued date',''

CREATE PROCEDURE rpt_BL_Standard_Business_License_Renewal_Report_No_Fees
...
SELECT BL.BLLICENSEID, BL.LICENSENUMBER, CASE WHEN BL.EXPIRATIONDATE = '1/1/2999' THEN NULL ELSE BL.EXPIRATIONDATE END AS EXPIRATIONDATE, BL.TAXYEAR, BL.ISSUEDDATE
	 ...
	 , CASE WHEN (SELECT ISNULL(R.REPORTTEXT,'') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Name') = '' 
		    THEN (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Municipality_Name')
		    ELSE (SELECT R.REPORTTEXT FROM RPTTEXTLIB R	WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Name') END Municipality_Name
	 , CASE WHEN (SELECT ISNULL(R.REPORTTEXT,'') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Address') = '' 
		    THEN (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Municipality_Address')
		    ELSE (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Address') END Municipality_Address
	 , CASE WHEN (SELECT ISNULL(R.REPORTTEXT,'') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Phone_Number') = '' 
	    	THEN (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Municipality_Phone_Number')
		    ELSE (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Municipality_Phone_Number') END Municipality_Phone_Number
     , (SELECT R.REPORTTEXT FROM RPTTEXTLIB R WHERE r.TEXTNAME = 'Business_License_Renewal_Report_Title') Business_License_Renewal_Report_Title
	 ...
	 , (SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Text1') Business_License_Renewal_Text1
	 , (SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Text2') Business_License_Renewal_Text2
	 , (SELECT REPLACE(R.REPORTTEXT,CHAR(10),'<BR>') FROM RPTTEXTLIB R WHERE R.TEXTNAME = 'Business_License_Renewal_Text3') Business_License_Renewal_Text3
...
INNER JOIN #FILTER ID ON BL.BLLICENSEID = ID.BLLICENSEID
